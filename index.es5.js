...
/**/{
  (function () {
        ...
        _createClass(Nav, [{
          ...
          value: function init() {
            ...
            config.items.forEach(function (option) {
              return new NavItem(option).to(_this9);
            });
          }
        }, {
          key: 'tagName',
        ...
        _createClass(FrameHeaderHamburger, [{
          ...
          value: function init() {
            ...
            this.element.addEventListener('click', function (event) {
              ...
              if (typeof _this13.onClick === 'function') _this13.onClick(event);
            });
          }
        }, {
          key: 'tagName',
        ...
        _createClass(FrameMenuList, [{
          ...
          value: function init() {
            ...
            this.list.forEach(function (item) {
              return new FrameMenuItem(item).to(_this18);
            });
          }
        }, {
          key: 'update',
        ...
        _createClass(FrameMenu, [{
          ...
          value: function init() {
            ...
            addEventListener('click', function (event) {
              ...
              _this21.element.classList.remove('active');
            });
            this.initCaption();
          ...
          value: function hashchange() {
            ...
            hxList.forEach(function (i) {
              if (i.textContent === text) {
                _this25.animating = true;
                var callback = function callback() {
                  return _this25.animating = false;
                };
                var offset = _this25.fixedOffset;
        ...
        _createClass(Frame, [{
          ...
          value: function init() {
            ...
            Promise.all([this.menu, this.content, this.hxList]).then(function (_ref) {
              ...
              _this30.frameBody = new FrameBody({ menu: menu, content: content, hxList: hxList }).to(_this30);
            }, function (error) {
              var name = error.name,
                  message = error.message;

              _this30.frameBody = new FrameError({ name: name, message: message }).to(_this30);
            });
          }
        }, {
          key: 'md',
          ...
          get: function get() {
            ...
            var value = Frame.$hljs.then(function () {
              ...
              var width = Math.min(_this31.element.offsetWidth - 28, 600);
    ...
    var $loading = load([load('//github.elemecdn.com/uglifyjs!YanagiEiichi/jinkela/1.2.14/jinkela.js').then(function () {
      return load('//github.elemecdn.com/uglifyjs!YanagiEiichi/jinkela/1.2.14/plugins/nesting.js');
