...
/**/{
  (function () {
    ...
    var render = function render(config) {
      ...
      var Nav = function (_Jinkela7) {
        ...
        _createClass(Nav, [{
          ...
          get: function get() {
            ...
            try {
              for (var _iterator = config.items[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var i = _step.value;
                value[i.href] = i;
              }
            } catch (err) {
      ...
      var FrameBody = function (_Jinkela16) {
        ...
        _createClass(FrameBody, [{
          ...
          value: function hashchange() {
            ...
            try {
              for (var _iterator2 = hxList[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                var i = _step2.value;

                if (i.textContent === text) {
                  this.animating = true;
                  var callback = function callback() {
                    return _this23.animating = false;
                  };
          ...
          value: function scroll() {
            ...
            if (!this.animating) {
              (function () {
                ...
                var offsetTop = _this24.element.offsetTop;
                var hxList = _this24.hxList;
                var left = 0;
                var right = hxList.length - 1;

                scrollTop += _this24.fixedOffset;
                ...
                clearTimeout(_this24.hashing);
                _this24.hashing = setTimeout(function () {
                  return _this24.hashing = null;
                }, 100);
                location.hash = hash;
              })();
            }
        ...
        _createClass(Frame, [{
          ...
          value: function init() {
            ...
            Promise.all([this.menu, this.content, this.hxList]).then(function (_ref) {
              ...
              _this28.frameBody = new FrameBody({ menu: menu, content: content, hxList: hxList }).renderTo(_this28);
            }, function (error) {
          ...
          get: function get() {
            ...
            var value = Frame.$hljs.then(function () {
              ...
              try {
                for (var _iterator3 = [].slice.call(aList)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                  var a = _step3.value;
                  a.target = '_blank';
                }
              } catch (err) {
      ...
      var Component = location.pathname === '/' ? Landing : Frame;
